...
public class WXNavigatorModule extends WXModule {
        ...
        if (!TextUtils.isEmpty(param)) {
            ...
            try {
                ...
                if (!TextUtils.isEmpty(url)) {
                    ...
                    String bottomIn = jsonObject.getString("bottomIn");
                    if ("true".equals(bottomIn)) {
                        Constants.bottomIn = true;
                        ((Activity) mWXSDKInstance.getContext()).overridePendingTransition(R.anim.activity_open, 0);
                    } else {
                        Constants.bottomIn = false;
                    }
    ...
    public void pop(String param, JSCallback callback) {
        ...
        if (mWXSDKInstance.getContext() instanceof Activity) {
            ...
            String bottomIn = jsonObject.getString("bottomIn");
            if ("true".equals(bottomIn)) {
                ((Activity) mWXSDKInstance.getContext()).overridePendingTransition(0, R.anim.activity_close);
            }
        }
    }

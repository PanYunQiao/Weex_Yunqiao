...
public class WXRecyclerView extends RecyclerView implements WXGestureObservable {
  ...
  public void customEdgeEffect(Context context) {
    try {
      //glow
      int glowDrawableId = context.getResources().getIdentifier("overscroll_glow", "drawable", "android");
      Drawable androidGlow = context.getResources().getDrawable(glowDrawableId);
      androidGlow.setColorFilter(getResources().getColor(R.color.weexPg_bar), PorterDuff.Mode.MULTIPLY);
      //edge
      int edgeDrawableId = context.getResources().getIdentifier("overscroll_edge", "drawable", "android");
      Drawable androidEdge = context.getResources().getDrawable(edgeDrawableId);
      androidEdge.setColorFilter(getResources().getColor(R.color.weexPg_bar), PorterDuff.Mode.MULTIPLY);
    } catch (Exception e) {
